...
mod tests {
    ...
    fn case_leetcodeisgreat() {
        assert_eq!(
            Solution::find_the_longest_substring(String::from("leetcodeisgreat")),
            5
        );
    }
    ...
    #[test]
    fn case_bcbcbc() {
        assert_eq!(Solution::find_the_longest_substring(String::from("bcbcbc")), 6);
    }

    #[test]
    fn case_id() {
        assert_eq!(Solution::find_the_longest_substring(String::from("id")), 1);
    }
